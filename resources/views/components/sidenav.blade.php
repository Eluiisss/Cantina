                ...
                <nav class="flex-1 space-y-1 bg-neutral-800">
                    ...
                    @else
                        <ul>
                            ...
                            <li>
                                <a class="inline-flex items-center w-full px-4 py-2 mt-1 text-base transform hover:translate-x-2 transition-transform ease-in duration-200 rounded-lg bg-white focus:shadow-outline dark:main-color-blue-bg" white="" 70="" href="#">
