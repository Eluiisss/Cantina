            ...
            <tr>
              ...
              <td class="py-4 whitespace-nowrap">
                  <div class="flex flex-shrink-0 items-center justify-end text-sm font-medium p-1 md:px-3">
                      <a href= "{{ route('users.show', ['user' => $row]) }}"class="p-1 md:p-2 mr-1 main-color-blue-bg rounded-sm">
                      ...
                      <a href="{{ route('users.edit', ['user' => $row]) }}" class="p-1 md:p-2 {{ $row->isAn('employee') | $row->isAn('user') ? 'mr-1' : ''}} main-color-blue-bg rounded-sm">
                          <svg class="w-3 h-3 md:w-5 md:h-5" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      @if($row->isAn('employee') | $row->isAn('user'))
                          <a href="{{ route('users.destroy', ['id' => $row->id]) }}" class="p-1 md:p-2 bg-red-700 rounded-sm">
                              <svg class="w-3 h-3 md:w-5 md:h-5" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
