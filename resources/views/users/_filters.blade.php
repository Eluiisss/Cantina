...
<form method="get" action="{{ route('users.index') }}">
    <div class="grid justify-items-end inline-block py-4 px-1 w-full">
        <div class="flex flex-auto justify-end w-5/6">
            <input type="search" name="search" value="{{ request('search') }}"
                   class="w-64 px-3 h-7 md:w-80 md:px-5 md:h-10 text-right text-xs border-transparent rounded-l-sm" placeholder="Buscar usuarios...">
            <button type="submit" class="px-1 md:px-3 main-color-blue-bg main-color-yellow-text rounded-r-sm">
        ...
        <div class="flex justify-between py-2 w-5/6 sm:w-72 md:w-96">
            <select name="role" id="role" class="w-20 h-7 p-0 md:w-28 md:h-9 text-3xs text-center main-color-blue-bg main-color-yellow-text border-transparent rounded-sm">
            ...
            <div class="grid justify-items-end inline-block">
                <div class="flex items-center">
                    <a href="#" class="px-1 py-1 md:px-2 md:py-2 bg-red-700 main-color-yellow-text rounded-l-sm">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" class="px-1 py-1 md:px-2 md:py-2 main-color-blue-bg main-color-yellow-text rounded-r-sm">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
